...
headers <- c('Year','Total_Obligated','Total_FedSpend','Total_Obligated_J40', 'FedSpend_J40', 'J40_Perc_FedSpend')
...
typeof(FY2021$cfda_number)  ## stored in CSVs as double, needs to align with Sophie's excel sheet
...
FY2021_filt_CFDA <- subset(FY2021, FY2021$cfda_number %in% Justice40CFDAs) 
...
FY2021_NationalTrend_DF <- data.frame(FY2021_year, FY2021_TotObl, FY2021_FedSpend, FY2021_TotOblJ40, FY2021_FedSpendJ40, FY2021_J40Perc_FedSpend)
colnames(FY2021_NationalTrend_DF) <- headers
National_TrendDF <- rbind(National_TrendDF, FY2021_NationalTrend_DF)
colnames(National_Trend_DF) <- headers ## need this just once to reset header names after rbind
...
typeof(FY2022$cfda_number)  ## stored in CSVs as double, needs to align with Sophie's excel sheet
Justice40_ProgramList <- read_csv("D:/CFDA_Sheet/Justice40_Combined_ConfirmedUnconfirmedCFDAs.csv")
typeof(Justice40_ProgramList$CFDA) # CSV read in as double also, so no need for conversion
Justice40CFDAs <- Justice40_ProgramList$CFDA # list of CFDAs, use for the subsetting statement
FY2022_filt_CFDA <- subset(FY2022, FY2022$cfda_number %in% Justice40CFDAs) 
...
FY2022_NationalTrend_DF <- data.frame(FY2022_year, FY2022_TotObl, FY2022_FedSpend, FY2022_TotOblJ40, FY2022_FedSpendJ40, FY2022_J40Perc_FedSpend)
...
typeof(FY2023$cfda_number)  ## stored in CSVs as double, needs to align with Sophie's excel sheet
Justice40_ProgramList <- read_csv("D:/CFDA_Sheet/Justice40_Combined_ConfirmedUnconfirmedCFDAs.csv")
typeof(Justice40_ProgramList$CFDA) # CSV read in as double also, so no need for conversion
Justice40CFDAs <- Justice40_ProgramList$CFDA # list of CFDAs, use for the subsetting statement
FY2023_filt_CFDA <- subset(FY2023, FY2023$cfda_number %in% Justice40CFDAs) 
...
FY2023_NationalTrend_DF <- data.frame(FY2023_year, FY2023_TotObl, FY2023_FedSpend, FY2023_TotOblJ40, FY2023_FedSpendJ40, FY2023_J40Perc_FedSpend)
...
typeof(FY2024$cfda_number)  ## stored in CSVs as double, needs to align with Sophie's excel sheet
Justice40_ProgramList <- read_csv("D:/CFDA_Sheet/Justice40_Combined_ConfirmedUnconfirmedCFDAs.csv")
typeof(Justice40_ProgramList$CFDA) # CSV read in as double also, so no need for conversion
Justice40CFDAs <- Justice40_ProgramList$CFDA # list of CFDAs, use for the subsetting statement
FY2024_filt_CFDA <- subset(FY2024, FY2024$cfda_number %in% Justice40CFDAs) 
...
FY2024_NationalTrend_DF <- data.frame(FY2024_year, FY2024_TotObl, FY2024_FedSpend, FY2024_TotOblJ40, FY2024_FedSpendJ40, FY2024_J40Perc_FedSpend)
...
FY2008_NationalTrend_DF <- data.frame(FY2008_year, FY2008_TotObl, FY2008_FedSpend, FY2008_TotOblJ40, FY2008_FedSpendJ40, FY2008_J40Perc_FedSpend)
...
FY2009_NationalTrend_DF <- data.frame(FY2009_year, FY2009_TotObl, FY2009_FedSpend, FY2009_TotOblJ40, FY2009_FedSpendJ40, FY2009_J40Perc_FedSpend)
...
FY2010_NationalTrend_DF <- data.frame(FY2010_year, FY2010_TotObl, FY2010_FedSpend, FY2010_TotOblJ40, FY2010_FedSpendJ40, FY2010_J40Perc_FedSpend)
...
FY2011_NationalTrend_DF <- data.frame(FY2011_year, FY2011_TotObl, FY2011_FedSpend, FY2011_TotOblJ40, FY2011_FedSpendJ40, FY2011_J40Perc_FedSpend)
...
FY2012_NationalTrend_DF <- data.frame(FY2012_year, FY2012_TotObl, FY2012_FedSpend, FY2012_TotOblJ40, FY2012_FedSpendJ40, FY2012_J40Perc_FedSpend)
...
FY2013_NationalTrend_DF <- data.frame(FY2013_year, FY2013_TotObl, FY2013_FedSpend, FY2013_TotOblJ40, FY2013_FedSpendJ40, FY2013_J40Perc_FedSpend)
...
FY2014_NationalTrend_DF <- data.frame(FY2014_year, FY2014_TotObl, FY2014_FedSpend, FY2014_TotOblJ40, FY2014_FedSpendJ40, FY2014_J40Perc_FedSpend)
...
FY2015_NationalTrend_DF <- data.frame(FY2015_year, FY2015_TotObl, FY2015_FedSpend, FY2015_TotOblJ40, FY2015_FedSpendJ40, FY2015_J40Perc_FedSpend)
...
FY2016_NationalTrend_DF <- data.frame(FY2016_year, FY2016_TotObl, FY2016_FedSpend, FY2016_TotOblJ40, FY2016_FedSpendJ40, FY2016_J40Perc_FedSpend)
...
FY2017_NationalTrend_DF <- data.frame(FY2017_year, FY2017_TotObl, FY2017_FedSpend, FY2017_TotOblJ40, FY2017_FedSpendJ40, FY2017_J40Perc_FedSpend)
...
FY2018_NationalTrend_DF <- data.frame(FY2018_year, FY2018_TotObl, FY2018_FedSpend, FY2018_TotOblJ40, FY2018_FedSpendJ40, FY2018_J40Perc_FedSpend)
...
FY2019_NationalTrend_DF <- data.frame(FY2019_year, FY2019_TotObl, FY2019_FedSpend, FY2019_TotOblJ40, FY2019_FedSpendJ40, FY2019_J40Perc_FedSpend)
...
FY2020_NationalTrend_DF <- data.frame(FY2020_year, FY2020_TotObl, FY2020_FedSpend, FY2020_TotOblJ40, FY2020_FedSpendJ40, FY2020_J40Perc_FedSpend)
